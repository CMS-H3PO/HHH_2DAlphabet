...
def test_fit(working_area,polyOrder,sigName=None,strategy=0,rInit=0,rMin=-1,rMax=10,setParams={},extra=''):
    ...
    twoD.MLfit('{0}_area'.format(polyOrder),strategy=strategy,rInit=rInit,rMin=rMin,rMax=rMax,setParams=setParams,extra=extra,verbosity=0)
