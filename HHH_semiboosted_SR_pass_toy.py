        ...
        for polyOrder in ["0","1","2","3"]:
            if options.year == "2017":
                if polyOrder in ["1"]:
                    ...
                    test_fit(working_area,polyOrder,defMinStrat=1, rMin=-5, rMax=5, setParams={'qcd_rpfT_2_par0':'7.0','qcd_rpfT_2_par1':'-10.0','qcd_rpfT_2_par2':'-0.4','qcd_rpfT_2_par3':'3.0','qcd_rpfT_2_par4':'5.0','qcd_rpfT_2_par5':'0.6'})
                elif polyOrder in ["3"]:
                    continue
                else:
