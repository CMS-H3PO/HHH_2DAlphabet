...
if __name__ == '__main__':
    ...
    bestOrder = {"{}_semiboosted_SR_pass_toy_multiSignal".format(options.year):"1"}
        ...
        for sig in sigNames:
            ...
            if options.condor:
                ...
                with open(exec_file, 'w') as e_file:
                    ...
                    e_file.write('\n')
                    e_file.write('echo HHH_semiboosted_SR_pass_toy_multiSignal.py $*\n')
                    e_file.write('python -u HHH_semiboosted_SR_pass_toy_multiSignal.py $*\n')
